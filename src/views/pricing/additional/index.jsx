...
import { deleteData, getAllData } from '@/api/pricing/additional';
...
class AdditionalPrice extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    const columns = [
      {
        title: 'Addtional Price Name',
        dataIndex: 'additionalPriceName',
        key: 'additionalPriceName',
      },
      {
        title: 'Service Type',
      ...
      {
        title: 'Addtional Price',
        dataIndex: 'additionalPrice',
        key: 'additionalPrice',
        render: (_, record) => `${toRupiah(_)}`,
      },
      {
        title: 'Description',
        ...
        render: (_, record) => (
          <Space size={'middle'}>
            ...
            <Button
              ...
              onClick={() => {
                this.setState({
                  deleteId: record.additionalPriceId,
    ...
    return (
      <div className='app-container'>
        ...
        <br />
        <Card title='LIST ADDITIONAL PRICE' extra={addBtn}>
          <Table
            size='small'
            dataSource={this.state.list}
            rowKey={(record) => record.additionalPriceId}
