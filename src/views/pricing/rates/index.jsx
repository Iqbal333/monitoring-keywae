...
import { deleteData, getAllData } from '@/api/pricing/rates';
...
class RatesPrice extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <div className='app-container'>
        ...
        <br />
        <Card title='LIST TARIF' extra={addBtn}>
          <Table
            size='small'
