...
import { ArrowLeftOutlined, IdcardFilled, MailFilled, ManOutlined, PhoneFilled, WalletFilled, WomanOutlined } from '@ant-design/icons';
    ...
    return this.state.loading ? (
      ...
      <Card title={<Header />}>
        <div className="content-container">
          <Image src={this.state.data?.photo ? this.state.data?.photo : noImage} width={this.state.widthPhoto} height={this.state.heightPhoto} />
          ...
          <div className="wallet">
            <WalletFilled style={{ color: "#136034", fontSize: 18 }} />
            <span className="wallet-title" style={{ color: "#136034" }}>KeyPay</span>
          </div>
          <span className="wallet-balance">Rp 0,0</span>
