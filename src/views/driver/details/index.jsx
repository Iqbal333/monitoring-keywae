      ...
      for (const property in datas) {
        if (
          ...
          if (property === 'vehicleTypes') {
            files.vehicleRegNumberFile =
              datas[property]['vehicleRegNumberFile'];
        ...
        <Col xs={24} md={6}>
          <DriverInfo 
            ...
            approvalAcc={() =>
              actionPrompt(
                'Aproval Driver',
                'Pastikan kembali data driver sudah lengkap!',
                'approve'
            )}
            approvalReject={() =>
              actionPrompt(
                'Tolak Driver',
                'Apakah anda yakin ingin menolak driver?',
                'reject'
            )}
            verifyAcc={() =>
              actionPrompt(
