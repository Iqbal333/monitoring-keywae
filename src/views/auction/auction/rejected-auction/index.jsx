...
import { rejectedAuction } from '@/api/auction/auction/rejectedAuction';
import {
  Card,
  Table,
  Avatar,
...
class RejectedAuction extends Component {
  constructor(props) {
    super(props);
  ...
  fetchData = () => {
    ...
    rejectedAuction(this.state.listQuery, this.state.filter).then(
      (response) => {
  ...
  render() {
      ...
      },
      {
        ...
        render: (data) => (
            <Space wrap direction='horizontal'>
                <Link to={`/auction/rejected-detail/${data.auctionId}`}>
    ...
    return (
      <div className='app-container'>
        ...
        <br />
        <Card title='Lelang Yang Ditolak'>
          <Table
            size='small'
