...
import { verificationAuction } from '@/api/auction/auction/verificationAuction';
import {
  Card,
  Table,
  Avatar,
...
class VerificationAuction extends Component {
  constructor(props) {
    super(props);
  ...
  fetchData = () => {
    ...
    verificationAuction(this.state.listQuery, this.state.filter).then(
      (response) => {
  ...
  render() {
    const columns = [
          ...
          render: (_) => (
            <>
              <Avatar
                ...
                size={35}
                src={
                  _?.lotImageLink !== null || _?.lotImageLink !== '' || _?.lotImageLink !== undefined
                    ? _?.lotImageLink
                    : noImage
                }
              />
      ...
      },
      {
        ...
        render: (tag) => (
            <>
              <Tag color={tag === 'Live' ? 'green' : 'blue'} key={tag}>
                {tag}
              </Tag>
            </>
          ),
      },
      {
        ...
        render: (data) => (
          <Space wrap direction='horizontal'>
            <Link to={`/auction/verification-detail/${data.auctionId}`}>
...
export default VerificationAuction;
