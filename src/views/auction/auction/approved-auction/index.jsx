...
import { approvedAuction } from '@/api/auction/auction/approvedAuction';
import {
  Card,
  Table,
  Avatar,
...
class ApprovedAuction extends Component {
  constructor(props) {
    super(props);
  ...
  fetchData = () => {
    ...
    approvedAuction(this.state.listQuery, this.state.filter).then(
      (response) => {
  ...
  render() {
      ...
      },
      {
        ...
        render: (data) => (
          <Space wrap direction='horizontal'>
            <Link to={`/auction/approved-detail/${data.auctionId}`}>
    ...
    return (
      <div className='app-container'>
        ...
        <br />
        <Card title='Semua Lelang Yang Disetujui'>
          <Table
            size='small'
...
export default ApprovedAuction;
