...
import { deleteData, getAllData } from '@/api/merchant/master/businessType';
...
class BusinessType extends Component {
  ...
  render() {
    const columns = [
      ...
      {
        title: 'Alias',
        dataIndex: 'businessTypeAlias',
        key: 'businessTypeAlias',
      },
      {
        title: 'Deskripsi',
        dataIndex: 'businessTypeDescription',
        key: 'businessTypeDescription',
        ellipsis: true,
      },
      {
        title: 'Action',
        ...
        render: (_, record) => (
          <Space size={'middle'}>
            ...
            <Button
              ...
              onClick={() => {
                this.setState({
                  deleteId: record.businessTypeId,
    ...
    return (
      <div className='app-container'>
        ...
        <br />
        <Card title='LIST TIPE BISNIS' extra={addBtn}>
          <Table
            size='small'
