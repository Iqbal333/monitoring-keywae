...
import { deleteData, getAllData } from '@/api/merchant/master/businessPermit';
...
class BusinessPermit extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    const columns = [
      {
        ...
        dataIndex: 'businessPermitTypeName',
        key: 'businessPermitTypeName',
        // align: 'center',
      },
      {
        title: 'Alias',
        dataIndex: 'businessPermitTypeAlias',
        key: 'businessPermitTypeAlias',
        // align: 'center',
      },
      {
        title: 'Deskripsi',
        dataIndex: 'businessPermitTypeDescription',
        key: 'businessPermitTypeDescription',
        ellipsis: true,
      },
      {
        title: 'Action',
        ...
        render: (_, record) => (
          <Space size={'middle'}>
            ...
            <Button
              ...
              onClick={() => {
                this.setState({
                  deleteId: record.businessPermitTypeId,
    ...
    return (
      <div className='app-container'>
        ...
        <br />
        <Card title='LIST TIPE IZIN BISNIS' extra={addBtn}>
          <Table
            size='small'
            dataSource={this.state.list}
            rowKey={(record) => record.businessPermitTypeId}
