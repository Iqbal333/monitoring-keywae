...
import { deleteData, getAllData } from '@/api/merchant/master/picRoles';
...
class PicRoles extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    const columns = [
      {
        title: 'Nama Role',
        dataIndex: 'picRoleName',
        key: 'picRoleName',
      },
      {
        title: 'Alias',
        dataIndex: 'picRoleAlias',
        key: 'picRoleAlias',
      },
      {
        title: 'Deskripsi',
        dataIndex: 'picRoleDescription',
        key: 'picRoleDescription',
        ellipsis: true,
      },
      {
        title: 'Action',
    ...
    return (
      <div className='app-container'>
        ...
        <br />
        <Card title='LIST ROLE PIC' extra={addBtn}>
          <Table
            size='small'
            dataSource={this.state.list}
            rowKey={(record) => record.picRoleId}
