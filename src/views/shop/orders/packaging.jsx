...
import { getPackaging } from '@/api/shops/orders';
...
class PackagingOrders extends Component {
  constructor(props) {
    super(props);
  ...
  fetchData = () => {
    ...
    getPackaging(this.state.listQuery, this.state.filter).then((response) => {
